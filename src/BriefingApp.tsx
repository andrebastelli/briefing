...
const steps: Step[] = [
  ...
  },
  {
    ...
    section: '7. Textos',
    fields: [
      { key: 'tom', label: 'Como você quer que os textos soem?', type: 'radio', options: ['Formal e sério', 'Amigável e descontraído', 'Técnico e especialista', 'Emocional e inspirador', 'Direto e objetivo', 'Premium e sofisticado', 'Outro'], required: true },
